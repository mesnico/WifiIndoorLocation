...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //getFragmentManager().beginTransaction().replace(android.R.id.content, new LocationMatchingPreferenceFragment()).commit();
        setupActionBar();
    }
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                || LocationMatchingPreferenceFragment.class.getName().equals(fragmentName)    //TODO: add all settings fragments
                || LocationStoringPreferenceFragment.class.getName().equals(fragmentName);
    }
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class LocationMatchingPreferenceFragment extends PreferenceFragment {
        @Override
    ...
    /**
     * This fragment shows location storing preferences only. It is used when the
     * activity is showing a two-pane settings UI.
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class LocationStoringPreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_storing);
            setHasOptionsMenu(true);
